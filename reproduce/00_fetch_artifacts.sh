...
ZENODO_FILES=(
    ...
    # --- ESM-2 precomputed embeddings (DTC only — benchmark embeddings are
    #     regenerated by 01_prepare_data.sh from Davis gene-name-keyed proteins) ---
...
# benchmark_proteins.csv is auto-generated by 01_prepare_data.sh from davis_benchmark.csv
