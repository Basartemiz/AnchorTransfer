...
# 7. Model
# ============================================================
from anchor_transfer.model.concise_anchor_v3 import ConciseAnchorV3

log.info("Building model...")
model = ConciseAnchorV3(
    ligand_dim=2048,
    residue_dim=1280,
    proj_dim=256,
    n_codes=3,
...
best_val = float('inf')
patience = 0
os.makedirs("models/concise_anchor_v3_dtc", exist_ok=True)
...
for ep in range(1, 101):
    ...
    if improved:
        ...
        torch.save({'model_state_dict': model.state_dict(), 'epoch': ep},
                    'models/concise_anchor_v3_dtc/best_model.pt')
    else:
        patience += 1
