...
Run from repo root:
    python -m experiments.experiment4.main                 # DTC (default)
    python -m experiments.experiment4.main --dataset bdb   # BindingDB
"""
...
from experiments.experiment4.train import CHECKPOINT_DIR, _macro_auroc, _macro_metrics, train_models
